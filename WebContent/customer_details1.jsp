...
{
	try{
		String cust_lo_id = request.getParameter("details");
		Connection con = null;
		String sql = null;
		String sql1 = null;
		Statement st = null;
		...
		while(rs.next()){
        	...
        	while(rs1.next()){
        		...
        		<input type=hidden value="<%=query_de%>" name="qdetails">
            	<td><input type="submit" Value="Details" formaction="employee_details1.jsp" style="text-transform: uppercase;background: #c59a6d;color: #282f35;border: 1px solid #c59a6d;border-radius: 0;font-size: 12px;color: #ffffff;transition: all 0.5s;width: 5em;  height: 2em;text-align: center"></td></tr>
         		</form><%
        	}
    	...
    	<input type="hidden" value="Customer Summary" name="act">
