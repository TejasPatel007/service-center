...
else
{
	...
	<div id="home">
	    ...
	    <div class="container text-center">
			...
			<form method="post" action="expertise.jsp">
		 	<button value="new expertise" style="text-transform: uppercase;background: #c59a6d;color: #282f35;border: 1px solid #c59a6d;border-radius: 0;font-size: 12px;color: #ffffff;transition: all 0.5s;width: 20em;  height: 3em;text-align: center" name="act">Add New Expertise</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		 	<button value="edit expertise" style="text-transform: uppercase;background: #c59a6d;color: #282f35;border: 1px solid #c59a6d;border-radius: 0;font-size: 12px;color: #ffffff;transition: all 0.5s;width: 20em;  height: 3em;text-align: center" name="act">Edit Expertise</button>
